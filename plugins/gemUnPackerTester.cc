...
using namespace std;
class gemUnPackerTester : public edm::one::EDAnalyzer<edm::one::SharedResources> {
public:
  explicit gemUnPackerTester(const edm::ParameterSet&);
  ~gemUnPackerTester();
...
gemUnPackerTester::gemUnPackerTester(const edm::ParameterSet& iConfig)
...
gemUnPackerTester::~gemUnPackerTester() {}

void gemUnPackerTester::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
...
void gemUnPackerTester::beginJob() {}

void gemUnPackerTester::endJob() {}

void gemUnPackerTester::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  descriptions.add("gemUnPackerTester", desc);
}

DEFINE_FWK_MODULE(gemUnPackerTester);
